...
DeviceTypeID_VTX        = 0x53            # # changed for Tacx i-Genius
...
RfFrequency_2466Mhz     =   60          # changed for Tacx i-Genius
...
class clsAntDongle():
    ...
    def VTX_ChannelConfig(self):                         # Pretend to be a Tacx i-Vortex
        ...
        messages=[
            ...
            msg43_ChannelPeriod         (channel_VTX, ChannelPeriod=0x1000), # changed for Tacx i-Genius
    ...
    def SlaveVTX_ChannelConfig(self, DeviceNumber):     # Listen to a Tacx i-Vortex
        ...
        messages=[
            ...
            msg43_ChannelPeriod         (channel_VTX_s, ChannelPeriod=0x1000), # changed for Tacx i-Genius
